...
MY_NAME=${MY_NAME:-"Szymon H"}
APP_URL=${APP_URL:-"https://github.com/jkanclerz/computer-programming-4/releases/download/v1.29/my-ecommerce-0.1.jar"} # to change later
